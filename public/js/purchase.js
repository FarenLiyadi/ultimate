        ...
        $('#search_product')
            .autocomplete({
                ...
                response: function (event, ui) {
                    // auto-pilih jika hanya 1 hasil & itu bukan dummy "notfound"
                ...
                focus: function (event, ui) {
                    // cegah highlight pada item dummy
                    if (ui.item && ui.item.notfound) {
                        event.preventDefault();
                    }
                },
            ...
            if (item.notfound) {
                return $li
                    ...
                    .append('<div class="text-muted">' + text + '</div>')
                    .appendTo(ul);
            }
            return $li.append('<div>' + text + '</div>').appendTo(ul);
        };
    }

    ...
    <script type="text/javascript">
        $(document).ready(function() {
            product_table = $('#product_table').DataTable({
             ...
             // Tampilkan kolom RACK hanya jika fitur rack aktif & lokasi terpilih (bukan "All/none")
            function toggleRackColumnVisibility() {
            var rackEnabled = $('#is_rack_enabled').val() == '1';
            var loc = $('#location_id').val();
            var hasLocation = !!loc && loc !== 'none' && loc !== '';
            // pakai selector nama kolom agar stabil
            product_table.column('rack:name').visible(rackEnabled && hasLocation);
           
            }
            toggleRackColumnVisibility();

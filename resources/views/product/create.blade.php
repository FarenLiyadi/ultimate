        ...
        <div class="col-sm-12">
            ...
            <div class="text-center">
                <div class="btn-group">
                    ...
                    <button type="submit" value="submit_n_add_selling_prices" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white submit_product_form">save & next</button>
                    @endif
